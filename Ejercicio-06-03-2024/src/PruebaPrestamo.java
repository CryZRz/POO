...
public class PruebaPrestamo {
    ...
    public void imprimir(Prestamo prestamo){
        double pago = 0;
        if (objPrestamo.getTipo() == 1) {
            pago = objPrestamo.getPagoMensual();
        }
        if (objPrestamo.getTipo() == 2) {
            pago = objPrestamo.getPagoMensual(1);
        }
        if (objPrestamo.getTipo() == 3) {
            pago = objPrestamo.getPagoMensual("a");
        }
